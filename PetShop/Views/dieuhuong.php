...
switch ($act) {
    ...
    case "taikhoan":
        ...
        if (isset($_SESSION['isLogins']) && $_SESSION['isLogins'] == true) {
            switch ($act) {
                case 'login':
            ...
            if ((isset($_SESSION['isLogin_Admins']) && $_SESSION['isLogin_Admins'] == true) || (isset($_SESSION['isLogin_Nhanviens']) && $_SESSION['isLogin_Nhanviens'] == true)) {
                switch ($act) {
                    case 'login':
                        require_once("login/login.php");
                        break;
