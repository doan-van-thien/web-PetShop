            ...
            <div class="col-xs-12">
                <div class="section-title text-center">
                    <div class="product-tab nav nav-tabs">
                        <ul>
                            <li class="active"><a data-toggle="tab" href="#arrival">Shop cho chó<span>/</span></a></li>
                            <li><a data-toggle="tab" href="#popular">Shop cho mèo <span></span></a></li>
            ...
            <div class="tab-pane fade" id="best">
                <div class="wrapper">
                    <ul class="load-list load-list-four">
                        ...
                        <li>
                            <div class="row text-center"><b><a href="?act=shop">Vào để xem nhiều hơn!</a></b></div>
                        </li>
                    </ul>
