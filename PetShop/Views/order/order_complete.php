			...
			<div class="col-xs-12 col-sm-6">
				<div class="order-details padding60">
					...
					<div class="por-dse clearfix">
						<ul>
							<li><span>Tên KH:<strong>:</strong></span> <?php echo $_SESSION['logins']['Ho'] . " " . $_SESSION['logins']['Ten'] ?></li>
							<li><span>Email<strong>:</strong></span> <?= $_SESSION['logins']['Email'] ?></li>
							<li><span>Số ĐT<strong>:</strong></span> <?= $_SESSION['logins']['SDT'] ?></li>
						</ul>
					</div>
				</div>
				<div class="order-address bill padding60">
					...
					<p><?= $_SESSION['logins']['DiaChi'] ?></p>
					<p>Phone: <?= $_SESSION['logins']['SDT'] ?></p>
					<p>Email: <?= $_SESSION['logins']['SDT'] ?></p>
				</div>
			</div>
		</div>
	</div>
