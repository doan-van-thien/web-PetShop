<header class="header-one header-two ">
    <div class="header-top-two header-top-2 ">
                            ...
                            <li>
                                ...
                                <ul>
                                    <?php if (isset($_SESSION['logins'])) { ?>
                                        <li><b>Chào <?= $_SESSION['logins']['Ho'] ?> <?= $_SESSION['logins']['Ten'] ?></b></li>
                                        <li><a href="?act=taikhoan&xuli=account">Tài khoản</a></li>
                                        <li><a href="?act=taikhoan&xuli=dangxuat">Đăng xuất</a></li>
                                        <?php
                                        if (isset($_SESSION['isLogin_Admins']) || isset($_SESSION['isLogin_Nhanviens'])) { ?>
    ...
    <div class="header-bottom  header-sticky" id="header">

        <div class="container text-center header1">
            <!-- thay container -> container2 -->
            <div class="row">
                <div class="col-sm-2">
                    <div class="logo">
                        <a href="?act=home"><img src="public/img/logo.png" alt="petshop" /></a>
                    </div>
                </div>
                <div class="col-sm-8">
