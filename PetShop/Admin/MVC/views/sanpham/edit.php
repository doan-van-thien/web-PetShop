...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <form action="?mod=sanpham&act=update" method="POST" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="" placeholder="" name="GiongLoai" value="<?= $data['GiongLoai'] ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <textarea class="form-control" id="summernote2" placeholder="" name="ThongTin"><?= $data['ThongTin'] ?></textarea>
        </div>
        <div class="form-group">
